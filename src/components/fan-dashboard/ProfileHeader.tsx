    ...
    <div className="relative w-full rounded-xl border border-gray-800 overflow-hidden ml-[60px] mr-[100px]">
      ...
      {onEditProfile && (
        <button
          ...
          className="absolute bottom-4 right-[180px] z-10 px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg text-sm font-medium transition-colors shadow-md"
        >
          Edit Profile
        </button>
      )}
